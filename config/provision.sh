...
echo "##############################"
gem install watir-webdriver -v 0.6.7 --no-rdoc --no-ri
gem install pry -v 0.9.12.6 --no-rdoc --no-ri
gem install sass -v 3.2.14 --no-rdoc --no-ri
gem install compass -v 0.12.2 --no-rdoc --no-ri
